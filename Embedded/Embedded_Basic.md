...
![image-20200807170209219](images/image-20200807170209219.png)
...
![image-20200807170451892](images/image-20200807170451892.png)

- 외부 워치독 타이머는 고가이므로 높은 신뢰성 요구하는 시스템에 주로 사용

### 나. WDT 구현 방법

![image-20200807170528165](images/image-20200807170528165.png)

- 워치독 타이머는 고정 또는 프로그래밍 가능한 시간 간격 가능, 다단계 워치독의 각 타이머는 각 다른 시간 간격 가능

## 4. WDT 하드웨어 내부구조

![image-20200807170626944](images/image-20200807170626944.png)
...
![image-20200807170817579](images/image-20200807170817579.png)
...
![image-20200807171644205](images/image-20200807171644205.png)