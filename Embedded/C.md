...
- `*numPtr`처럼 포인터를 역참조한 것과 `numPtr[0]` 처럼인덱스 0에 접근한 것은 같은 값을 가져온다. 그리고 `numPtr[1]`과 `*(numPtr+1)`도 같은 값을 가져오는데 후자와 같은 방식을 포인터 연산이라고 한다.
  ...
  ![image-20200805113154568](images/image-20200805113154568.png)
...
![image-20200805113606211](images/image-20200805113606211.png)
...
![image-20200805160117998](images/image-20200805160117998.png)
...
![image-20200805160521339](images/image-20200805160521339.png)
...
![image-20200805163545310](images/image-20200805163545310.png)
